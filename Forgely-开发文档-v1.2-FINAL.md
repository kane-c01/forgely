...
**V1(前 3 个月)**: 6. Sites - 站点管理 7. Content Moderation - 内容审核 8. AI Operations - AI 监控 9. Support - 工单 10. Platform Settings - 平台配置

**V2(6 个月+)**: 11. Analytics - 深度分析 12. Marketing - 营销工具 13. Plugins & Themes - 插件审核 14. System Health - 基础设施监控
