      ...
      <div className="container-page relative z-10 flex min-h-[88vh] flex-col justify-center gap-12 py-24 lg:py-32">
        <div className="flex flex-col gap-8 lg:max-w-4xl">
          <Badge tone="forge" className="self-start">
            <span className="h-1.5 w-1.5 rounded-full bg-forge-orange shadow-glow-forge" aria-hidden="true" />
          ...
          <p className="max-w-2xl text-body-lg text-text-secondary md:text-xl">
            Forge cinematic brand sites from a single link. Forgely turns any
            product URL into a fully-stocked store with motion, voice, and
            commerce — designed by AI, hosted on us, ready to sell in 5 minutes.
          </p>
        </div>
